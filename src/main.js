...
const renderTask = (taskListElement, task) => {
  ...
  taskComponent.getElement().querySelector(`.card__btn--edit`).addEventListener(`click`, onEditClick);

  taskEditComponent.getElement().querySelector(`form`).addEventListener(`submit`, onSubmitClick);
